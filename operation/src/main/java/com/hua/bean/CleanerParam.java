...
public final class CleanerParam
{
	...
	private static final String CONFIG_PATH = "/conf/properties/funshion.properties";
	...
	static
	{
		...
		instance.setRelativePath(props.getProperty("fs.windows.funshion.relative.path"));
		
		// 文件/目录名称正则
		final String regexs = props.getProperty("fs.windows.funshion.name.regexs");
		// 拦截空设置
